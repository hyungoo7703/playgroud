          ...
          >
            <svg 
              class="flex-shrink-0 w-6 h-6 mr-4 transition-colors
                {$currentPage === item.id ? 'text-indigo-600 dark:text-indigo-300' : 'text-gray-400 group-hover:text-gray-500 dark:text-gray-500 dark:group-hover:text-gray-300'}" 
              fill="none" 
              stroke="currentColor" 
              viewBox="0 0 24 24" 
